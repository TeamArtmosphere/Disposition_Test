...
const MainInfo = ({ placeData, onDesktop }: MainInfoProps) => {
  return (
    <Box>
      <Typography variant='h2' mb={onDesktop ? '24px' : '4px'} color={'secondary.contrastText'}>
        {placeData.name}
      </Typography>
      <Typography variant='h5' mb={onDesktop ? '24px' : '4px'} color={'grey.300'}>
        {placeData.address}
      </Typography>
